...
| clamav.freshclam.mirrors[0] | string | `"db.uk.clamav.net"` |  |
| clamav.freshclam.mirrors[1] | string | `"database.clamav.net"` |  |
...
| clamav.scaling.memoryTarget | int | `80` | The target memory usage percentage for clamav |
