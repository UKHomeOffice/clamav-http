...
{{/*
Create the name for a certificate secret.
*/}}
{{- define "clamav.certsecretname" -}}
{{- if .Values.clamav.certificate.secretName -}}
{{- .Values.clamav.certificate.secretName -}}
{{- else -}}
{{ include "clamav.fullname" . }}-tls
{{- end -}}
{{- end -}}
